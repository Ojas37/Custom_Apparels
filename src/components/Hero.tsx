...
export const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-cover bg-center opacity-[0.20] pointer-events-none transition-all duration-700"
        style={{
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto mt-28 md:mt-24 mb-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center z-20 px-4 md:px-8">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left">
          {/* Eyebrow Pill */}
          <div className="inline-flex items-center gap-2 self-start px-4 py-1.5 rounded-full text-[10px] md:text-xs font-semibold bg-white/5 text-white/95 border border-white/10 tracking-widest mb-6">
            <span>PREMIUM CUSTOM MERCHANDISE</span>
          </div>

          {/* Headline */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-white font-extrabold tracking-tight leading-[0.9] mb-4 md:mb-6">
            Wear What<br />
            <span className="font-serif italic font-normal text-zinc-400 lowercase tracking-normal">matters.</span>
          </h1>

          {/* Subheadline */}
          <p className="text-white/90 text-sm md:text-lg lg:text-xl font-medium leading-relaxed max-w-2xl mb-2">
            Custom apparel, corporate merchandise, creator merch and branded products made exactly the way you imagine.
          </p>

          {/* Supporting Line */}
          <p className="text-white/50 text-xs md:text-sm leading-relaxed max-w-xl mb-8">
            From a single custom piece to thousands of branded merchandise units, we handle everything from design to delivery.
          </p>

          {/* Button CTAs */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-10 pointer-events-auto">
        ...
        <div className="lg:col-span-5 relative w-full flex justify-center items-center py-8 lg:py-0 select-none">
          <div className="relative w-full max-w-[280px] sm:max-w-[320px] md:max-w-[340px] h-[360px] sm:h-[400px] md:h-[420px] rounded-[3rem] border border-white/10 bg-zinc-900/40 p-3 shadow-2xl">
            ...
            <div className="absolute top-12 -right-4 md:-right-8 bg-zinc-950/90 border border-white/10 rounded-2xl p-3 shadow-2xl flex flex-col gap-2 w-32 pointer-events-auto">
            ...
            <div className="absolute bottom-6 -left-6 md:-left-10 bg-zinc-950/95 border border-white/10 rounded-2xl p-2.5 shadow-2xl flex items-center gap-3 w-48 pointer-events-auto hover:scale-102 transition-transform duration-300">
              <img
            ...
            <div className="absolute bottom-16 -right-4 md:-right-8 w-16 h-16 rounded-full bg-white text-black font-extrabold flex flex-col items-center justify-center text-center text-[8px] uppercase tracking-wider leading-none shadow-2xl rotate-6 hover:rotate-0 transition-transform duration-300 cursor-default">
              <span>Create</span>
